            ...
            <ul className="grid w-[400px] gap-3 p-4 md:w-[500px] md:grid-cols-2 lg:w-[600px] text-left">
              <li className="row-span-3">
                <NavigationMenuLink asChild>
                  <Link
                    className="flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-survival-50 to-survival-100 p-6 no-underline outline-none focus:shadow-md text-left"
                    to="/services/solo-401k"
                    onClick={scrollToTop}
                  >
                    <div className="mb-2 mt-4 text-lg font-medium text-survival-800 flex items-center gap-2 text-left">
                      <Home className="h-5 w-5" />
                      Solo 401k
                    </div>
                    <p className="text-sm leading-tight text-survival-700 text-left">
