            ...
            <div className="bg-survival-50 rounded-xl p-6 border border-survival-100 mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-5 rounded-lg shadow-sm">
                  ...
                  <p className="text-sm text-gray-700 text-left">We'll analyze whether leasing or purchasing is more advantageous for your specific situation, factoring in your service type, expected usage patterns, and financial goals.</p>
                </div>
                
                <div className="bg-white p-5 rounded-lg shadow-sm">
                  <h4 className="font-semibold text-finance-700 mb-2">Documentation System</h4>
                  <p className="text-sm text-gray-700 text-left">Set up proper record-keeping systems to track business vs. personal use, maintenance records, and all vehicle-related expenses for maximum tax benefits.</p>
                </div>
                
                <div className="bg-white p-5 rounded-lg shadow-sm">
                  <h4 className="font-semibold text-finance-700 mb-2">Insurance Optimization</h4>
                  <p className="text-sm text-gray-700 text-left">Guidance on proper insurance coverage for vehicles owned by your LLC, including commercial auto policies tailored to first responder business activities.</p>
                </div>
                
                <div className="bg-white p-5 rounded-lg shadow-sm">
                  <h4 className="font-semibold text-finance-700 mb-2">Tax Planning</h4>
                  <p className="text-sm text-gray-700 text-left">Strategic timing of vehicle purchases to optimize tax deductions across tax years and maximize available incentives and depreciation benefits.</p>
                </div>
              </div>
            </div>
          </div>
